...
<label class="radio-inline"><input type="radio" id="view" name="optradio"><strong class="text-info">Employees</strong></label>
<label class="radio-inline"><input type="radio" id="views" name="optradio"><strong class="text-danger">Department</strong></label>
   </center> 
      </div>
    </div>
...
<div class="table-responsive">
   ...
   <div class="panel panel-primary filterable">
     <div class="panel-heading"><center><h3 class="panel-title">My Department Employee Details</h3></center>
...
SELECT mailid FROM assignmanagers WHERE deptid=(SELECT deptid FROM assignmanagers WHERE mailid='employee@gmail.com'))*/
    ...
    $sql = "SELECT a.id, d.deptname, d.deptlocation, r.fullname, a.mailid, d.deptdesc FROM assignmanagers a, department d, register r WHERE a.deptid=d.id AND a.mailid=r.emailid AND r.role='employee' AND a.deptid='$deptid' ";
...
<div class="table-responsive">
   ...
   <div class="panel panel-primary filterable">
     <div class="panel-heading"><center><h3 class="panel-title">Department & Manager Details</h3></center>
       <div class="pull-right">
          <button class="btn btn-default btn-xs btn-filter"><strong><span class="glyphicon glyphicon-filter"></span> Filter</strong></button>
       </div>
      </div>
...
include "connection.php";
    ...
    $sql = "SELECT a.id, d.deptname, d.deptlocation, d.deptdesc, a.mailid, r.fullname FROM assignmanagers a, department d, register r WHERE a.mailid=r.emailid AND a.deptid=d.id AND r.role='manager' ";
