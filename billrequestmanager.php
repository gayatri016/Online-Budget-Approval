...
<button type="button" class="viewmodal btn btn-warning btn-sm" data-toggle="modal"><i class ="fa fa-eye"></i> View</button>
 <a href="billprocess.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">Go to</a>
</td>
<?php
