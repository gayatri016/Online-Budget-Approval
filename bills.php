...
<label class="radio-inline"><input type="radio" id="add" name="optradio"><strong class="text-success">Add Bills</strong></label>
<label class="radio-inline"><input type="radio" id="view" name="optradio"><strong class="text-danger">View Bills</strong></label>
   </center> 
      </div>
    </div>
 <div id="addbills">
<center><h3><strong>Bills</strong></h3>
<?php
            if(isset($_GET['error'])==true){
                if($_GET['error']==1){ 
                echo "<b style='color:red'>*&nbsp; Bills details alreary exist. </b>";       
                }
                elseif($_GET['error']==2){
                echo "<b style='color:red'>*&nbsp; Bills details is not successfully added . </b>";
                }
                elseif($_GET['error']==3){  
                echo "<b style='color:#3333ff'>*&nbsp; Bills details is successfully done. </b>";       
                }
            }
            ?>
</center>            
...
<br><br>         
<form method="POST" action="billsaction.php" enctype="multipart/form-data" >
<div class="row">
  <div class="col-xs-12 col-sm-5 form-group">
    <div class="input-group">
     <span class="input-group-addon"><i class ="fa fa-inr"></i></span>
      <input type="text" class="form-control" id ="billname" placeholder="Bill Name" name="billname" required>
    </div>
  </div>
  <div class="col-xs-12 col-sm-5 form-group">
    <div class="input-group">
     <span class="input-group-addon"><i class ="fa fa-inr"></i></span>
      <input type="text" class="form-control" id ="billamount" placeholder="Max - Amount" name="billamount" required maxlength="10" title="The amount must enter digits number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
  </div>
</div> 
</div> 
<div class="row">
...
<div id="viewbills" style="display:none">
  <div id="row">
...
<td>
   ...
   <a href="billedit.php?id=<?php echo $row['id'] ?>" class="btn btn-info btn-sm">Update</a>
</td>
<?php
