...
<a href="billrequestfncmanager.php" class="btn btn-info btn-sm pull-right"><i class ="fa fa-angle-double-left"></i> &nbsp; Back</a>
<br>
<div class="row">
...
<?php
    ...
    $sql = "SELECT b.billname, b.billamount, q.amount, q.status, q.billdesc, q.managerdesc, q.fncmanagerdesc FROM billrequest q, bills b WHERE q.billid=b.id AND q.id='$id' ";
...
<div class=""> 
<form method="post" action="billprocessfncaction.php" enctype="multipart/form-data">

<div class="row">
  <div class="col-xs-12 col-sm-5 form-group">
   <input type="hidden" class="form-control" id="billrequestid" name="billrequestid" value='<?php echo $id; ?>' readonly>
   <input type="hidden" class="form-control" id="fncmanagermailid" name="fncmanagermailid" value='<?php echo $email; ?>' readonly>
  </div>
</div>
...
<div class="col-xs-12 col-sm-5 form-group">
    ...
    <select class="form-control" id="status" name="status" required>
      <option value="<?php echo $row['status']; ?>"><?php echo $row['status']; ?></option>
         ...
         <option value="Not-Sanction">Not-Sanction</option>
      </select>
     </div>
   </div>
</div>
...
<div class="row">
  <div class="col-xs-12 col-sm-10 form-group">
    <label for="">Manager Feedback :</label>
    <textarea class="form-control" rows="2" id="managerdesc" name="managerdesc" placeholder="Give the feedback about  in 4000 words." value="<?php echo $row['managerdesc'];?>" readonly><?php echo $row['managerdesc'];?></textarea> 
  </div> 
</div>   
<div class="row">
  <div class="col-xs-12 col-sm-10 form-group">
    <label for="">Your Feedback :</label>
    <textarea class="form-control" rows="2" id="fncmanagerdesc" name="fncmanagerdesc" placeholder="Give the feedback about  in 4000 words." value="<?php echo $row['fncmanagerdesc'];?>" required><?php echo $row['fncmanagerdesc'];?></textarea> 
  </div> 
</div>     
